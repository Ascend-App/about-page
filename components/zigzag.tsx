      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-gray-100 bg-green-400 rounded-full mb-4">
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Quick customization with just a few taps</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>
                        Instant access to personalized meditation experiences
                      </span>
                    </li>
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Uses A.I. and natural language processing</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>
                        Customization based on mood, goals, and preferences
                      </span>
                    </li>
                    <li className="flex items-center">
                      <svg
                      ...
                      <span>
                        Machine learning applied for personal sessions
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>
                        Discover the untapped potential within yourself
                      </span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
