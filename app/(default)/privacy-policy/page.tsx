      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
            ...
            <p className="text-gray-600 mb-4">Last updated: July 24, 2024</p>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Ascend Holdco,
                LLC, 9621 South Dixie Highway.
              </li>
              <li>
            ...
            <p className="mb-4">
              By using our meditation app, you agree to the following terms
              regarding age restrictions: Users must be at least 13 years old to
              use the app. Users between the ages of 13 and 18 must have
              parental or guardian consent to use the app. By using the app,
              these users confirm that they have obtained such consent. If you
              are a user between the ages of 13 and 18, your parent or guardian
              must review and agree to these terms and conditions on your
              behalf. Parents or guardians are responsible for ensuring that
              users in this age group understand and comply with all terms and
              conditions. Users who do not meet these age requirements or fail
              to obtain the necessary parental consent are prohibited from using
              the app. Failure to comply with these age restrictions may result
              in the termination of the user's account or access to the service.
              By agreeing to these terms, users acknowledge that they understand
              and accept the age restrictions and the potential consequences for
              violations.
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-4">Subscriptions</h2>
            <h3 className="text-xl font-medium mb-2">Subscription period</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-2">Fee Changes</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">By email: support@ascendmeditations.app</p>
          </div>
        </div>
      </div>
    </section>
